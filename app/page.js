    ...
    <div className="relative z-10 container mx-auto px-12">
     ...
     <h1 className="text-4xl pt-8   font-mono font-bold text-center justify-center flex text-white mb-8">
      ...
      <div className="flex gap-2">  
         <a href="https://x.com/experiment_0000" className=" text-white text-4xl"><svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<stop offset="1" stop-color="#007AD9"/>
      ...
      <a href="https://t.me/experiment01sai" className=" text-white text-4xl"><svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
